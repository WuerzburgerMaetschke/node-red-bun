...
try {
    var extraModulePaths = [
        path.resolve(process.cwd(), "node_modules"),
        path.resolve(process.cwd(), "packages", "node_modules")
    ];
    var nodePath = extraModulePaths.join(path.delimiter);
    process.env.NODE_PATH = process.env.NODE_PATH ? nodePath + path.delimiter + process.env.NODE_PATH : nodePath;
    if (typeof Module._initPaths === "function") {
        Module._initPaths();
    }
} catch(err) {
    // Ignore path bootstrap errors and use default resolution.
}

function preloadBunCompileDependencies() {
...
preloadBunCompileDependencies();

var RED = require("./lib/red.js");
var bunGateway = require("./lib/bun-gateway");
