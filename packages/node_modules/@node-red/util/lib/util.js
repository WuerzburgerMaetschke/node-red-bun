            ...
            if (msg.hasOwnProperty(key)) {
                ...
                if (val !== undefined && val !== null) {
                    if (typeof val === "function") {
                        ...
                        // console.debug("[Node-RED Bun Fix] function kept as reference for key:", key);
                        m[key] = val;
                    } else if (typeof val === "object") {
                        if (typeof structuredClone === "function") {
                            try {
                                m[key] = structuredClone(val);
                                // console.debug("[Node-RED Bun Fix] structuredClone succeeded for key:", key);
                            } catch(e) {
                                console.warn("[Node-RED Bun Fix] structuredClone failed for key:", key, "- Error:", e.message, "- falling back to clonedeep");
                                m[key] = clonedeep(val);
                            }
                        } else {
                            m[key] = clonedeep(val);
