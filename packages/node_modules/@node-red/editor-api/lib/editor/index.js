...
function resolveEditorClientPath() {
    try {
        return path.dirname(require.resolve("@node-red/editor-client/package.json"));
    } catch(err) {
        return path.dirname(require.resolve("@node-red/editor-client/package.json", {
            paths: [path.resolve(process.cwd(), "packages", "node_modules")]
        }));
    }
}
...
module.exports = {
    ...
    start: function() {
        var catalogPath = path.resolve(path.join(resolveEditorClientPath(),"locales"));
